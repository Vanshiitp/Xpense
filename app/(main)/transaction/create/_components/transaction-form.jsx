...
export function AddTransactionForm({ accounts, categories, editMode = false, initialData = null,}) {
  ...
  // New function to handle scan errors
  ...
  return (
    <div className="max-w-3xl mx-auto px-2">
      <div className="flex justify-center w-full px-2">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 w-full max-w-xl bg-white rounded-lg shadow p-4 sm:p-8">
          {/* Receipt Scanner - Only show in create mode */}
          {!editMode && <ReceiptScanner onScanComplete={handleScanComplete} onScanError={handleScanError}/>}
          {/* Type */}
          ...
          {/* Category */}
           {/* Using the Controller to properly handle the category update  */}
            <Controller
            name="category"
            control={control}
            render={({ field }) => (
